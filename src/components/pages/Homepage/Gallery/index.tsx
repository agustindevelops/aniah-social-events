...
const Gallery = async () => {
  ...
  return (
    <div className="bg-white py-12 relative overflow-hidden text-center">
      ...
      <Link
        href="/gallery"
        className="font-bold bg-green-500 hover:bg-green-700 inline-flex items-center px-8 py-4 text-2xl text-white border border-transparent rounded-full shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200"
      >
        View Gallery
      </Link>
    </div>
